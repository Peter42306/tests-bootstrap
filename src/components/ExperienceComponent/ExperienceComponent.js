  ...
  <Card className='mt-3'>
    <Card.Body>
        ...
        <div className="mb-4">
          ...
          <p>
            Designing and developing web applications using ASP.NET Core (MVC, Razor Pages, Web API), EF Core, and React.
          </p>
          <p>
            Experience with both backend and frontend development, relational databases, and fullstack deployment.
          </p>
          <p className="text-muted fst-italic mt-2">
            Note: All development experience to date has been gained through the personal projects, learning and practice. Currently seeking to transition into a commercial .NET development role.
          </p>
        </div>
        <Accordion>
          <Accordion.Item eventKey='1'>
            ...
            <p>
              Applied Authorization, Authentication, JWT tokens for projects with ASP.NET core Web API from backend and React from fromend.
            </p>
            <p>  
